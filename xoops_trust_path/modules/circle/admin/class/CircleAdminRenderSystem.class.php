...
define('CIRCLE_ADMIN_RENDER_TEMPLATE_DIRNAME','templates');
define('CIRCLE_ADMIN_RENDER_FALLBACK_PATH',XOOPS_MODULE_PATH . '/legacy/admin/theme');    // TODO will be use other path
define('CIRCLE_ADMIN_RENDER_FALLBACK_URL',XOOPS_MODULE_URL . '/legacy/admin/theme');    // TODO will be use other url

/**
 * Circle_AdminRenderSystem
**/
class Circle_AdminRenderSystem extends Legacy_AdminRenderSystem
{
    /**
     * prepare
     * 
    ...
    **/
    public function renderTheme(/*** XCube_RenderTarget ***/ &$target)
    {
        ...
        $info = Circle_AdminRenderSystem::getOverrideFileInfo('admin_theme.html');
        $this->mSmarty->template_dir = ($info['file'] != null) ?
            substr($file['path'],0,-15) :
            CIRCLE_ADMIN_RENDER_FALLBACK_PATH;
    ...
    **/
    ...
    {
        $info = Circle_AdminRenderSystem::getOverrideFileInfo($target->getTemplateName());
    ...
    **/
    public static function getOverrideFileInfo(/*** string ***/ $file,/*** string ***/ $prefix = null,/*** bool ***/ $isSpDirName = false)
    {
        ...
        {
            $handler =& Circle_Utils::getXoopsHandler('module');
        ...
        switch(true)
        {
            ...
            case $isModule && file_exists(
                ...
                $ret['dirname'] = $trustDirName;
                return $ret;
            case file_exists($path = CIRCLE_ADMIN_RENDER_FALLBACK_PATH . '/' .$file):
                $ret['url'] = CIRCLE_ADMIN_RENDER_FALLBACK_URL . '/' . $file;
                $ret['path'] = $path;
                $ret['theme'] = null;
                $ret['dirname'] = null;
                return $ret;
    ...
    **/
    ...
    {
        $info = Circle_AdminRenderSystem::getOverrideFileInfo($str);
        if($info['url'] != null)
        {
            return $info['url'];
        }
        return CIRCLE_ADMIN_RENDER_FALLBACK_URL . '/' . $str;
    }
    ...
    **/
    public static function functionStylesheet(/*** {string 'file',string 'media'} ***/ $param,/*** Smarty ***/ &$smarty)
    {
        ...
        $info = Circle_AdminRenderSystem::getOverrideFileInfo($params['file'],'stylesheets/');
        if($info['file'] == null)
        {
            return;
        }
