...
**/
abstract class Circle_AbstractAction
{
    ...
    **/
     ...
     * @param   void
     * 
     * @return  Circle_{Tablename}Handler
    **/
	...
	**/
	...
	{
		$this->mAccessController['main'] = Circle_Utils::getAccessControllerObject($this->mAsset->mDirname, $dataname);
	}
    /**
