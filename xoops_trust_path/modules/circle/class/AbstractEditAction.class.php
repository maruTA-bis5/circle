...
/**
 * Circle_AbstractEditAction
**/
abstract class Circle_AbstractEditAction extends Circle_AbstractAction
{
    ...
    **/
    public function getDefaultView()
    {
        ...
        {
            return CIRCLE_FRAME_VIEW_ERROR;
        }
    
        $this->mActionForm->load($this->mObject);
    
        return CIRCLE_FRAME_VIEW_INPUT;
    }
    ...
    **/
    public function execute()
    {
        ...
        {
            return CIRCLE_FRAME_VIEW_CANCEL;
        }
    ...
    **/
    ...
    {
        $this->mRoot->mController->executeRedirect($this->_getNextUri($this->_getConst('DATANAME')), 1, _MD_CIRCLE_ERROR_DBUPDATE_FAILED);
    }
