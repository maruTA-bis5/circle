...
/**
 * Circle_AbstractListAction
**/
abstract class Circle_AbstractListAction extends Circle_AbstractAction
{
	public /*** XoopsSimpleObject[] ***/ $mObjects = null;

	public /*** Circle_AbstractFilterForm ***/ $mFilter = null;
	 ...
	 * @param	void
	 * 
	 * @return	Circle_{Tablename}FilterForm
	**/
