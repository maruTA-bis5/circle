...
/**
 * Circle_AbstractViewAction
**/
abstract class Circle_AbstractViewAction extends Circle_AbstractAction
{
	...
	**/
	...
	{
		$this->mRoot->mController->executeRedirect($this->_getNextUri($this->_getConst('DATANAME'), 'list'), 1, _MD_CIRCLE_ERROR_CONTENT_IS_NOT_FOUND);
	}
}
