...
require_once CIRCLE_TRUST_PATH . '/class/AbstractAccessController.class.php';

/**
 * Circle_GroupAccessController
**/
class Circle_GroupAccessController extends Circle_AbstractAccessController
{
	public $mType = 'group';
