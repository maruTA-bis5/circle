 ...
 * tag client delegate
**/
class Circle_TagClientDelegate implements Legacy_iTagClientDelegate
{
    /**
     * getClientList
     *
    ...
    public static function getClientList(/*** mixed[] ***/ &$list, /*** string ***/ $tDirname)
    {
        ...
        foreach($dirnames as $dir){
            ...
            if(Circle_Utils::getModuleConfig($dir, 'tag_dirname')==$tDirname){
                $list[] = array('dirname'=>$dir, 'dataname'=>'people');
    ...
    public static function getClientData(/*** mixed ***/ &$list, /*** string ***/ $dirname, /*** string ***/ $dataname, /*** int[] ***/ $idList)
    {
        ...
        //setup client module info
        $cri = Circle_Utils::getListCriteria($dirname);
