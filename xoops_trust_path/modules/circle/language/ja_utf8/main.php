...
define('_MD_CIRCLE_ERROR_REQUIRED', '{0}は必ず入力して下さい');
define('_MD_CIRCLE_ERROR_MINLENGTH', '{0}は半角{1}文字以上にして下さい');
define('_MD_CIRCLE_ERROR_MAXLENGTH', '{0}は半角{1}文字以内で入力して下さい');
define('_MD_CIRCLE_ERROR_EXTENSION', 'アップロードされたファイルは許可された拡張子と一致しません');
define('_MD_CIRCLE_ERROR_INTRANGE', '{0}の入力値が不正です');
define('_MD_CIRCLE_ERROR_MIN', '{0}は{1}以上の数値を指定して下さい');
define('_MD_CIRCLE_ERROR_MAX', '{0}は{1}以下の数値を指定して下さい');
define('_MD_CIRCLE_ERROR_OBJECTEXIST', '{0}の入力値が不正です');
define('_MD_CIRCLE_ERROR_DBUPDATE_FAILED', 'データベースの更新に失敗しました');
...
define('_MD_CIRCLE_LANG_UID', 'Uid');
